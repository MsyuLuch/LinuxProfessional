...
Создадим на lv_root файловую систему и смонтируем его, чтобы перенести туда данные:
...
Теперь нам нужно изменить размер старой VG и вернуть на него \. 
...
После чего можно успешно перезагружаемся в новую (уменьшенную root):
